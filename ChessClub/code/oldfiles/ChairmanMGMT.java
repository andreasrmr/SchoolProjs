            ...
            case 3:
                ...
                switch (readInt()){
                    case 1:
                        ...
                        member.setFirstName(readString());
                        break;
                    case 2:
                        System.out.print("Enter lastname: ");
                        member.setLastName(readString());
                        break;
                    case 3:
                        System.out.print("Enter birthday (dd/mm/yyyy): ");
                        member.setBirthDay(readString());
                        break;
                    case 4:
                        System.out.print("Enter gender: ");
                        member.setGender(readString());
                        break;
                    case 5:
                        System.out.print("Enter cpr: ");
                        member.setCpr(readInt());
                        break;
                    case 6:
                        System.out.print("Enter phone number (xxxxxxxx): ");
                        member.setPhoneNumber(readInt());
                        break;
                    case 7:
                        System.out.print("Enter email: ");
                        member.setEmail(readString());
                        break;
                    case 9:
